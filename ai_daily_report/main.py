...
def send_self_check_alert(alert_message: str):
    ...
    <body>
        <div class="alert">
            <div class="title">⚠️ AI日报系统自检告警</div>
    ...
    """
    email_sender._send_email(alert_html, f"【AI日报告警】系统自检发现问题 - {datetime.now().strftime('%Y-%m-%d')}")
    
    # 发送企微告警
    wecom_sender = WeComSender()
    wecom_sender.send_alert("AI日报系统自检告警", alert_message + "\n\n请检查 GitHub Actions 运行日志")
