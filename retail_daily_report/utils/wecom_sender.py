...
if __name__ == "__main__":
    ...
    sender = WeComSender()
    test_summary = {
        "expert_summary": "今日零售行业动态活跃，便利店和会员店赛道持续扩张...",
        "total_news": 36,
        "p1_count": 5,
        "p1_news": [
            {"title": "山姆会员店宣布新增10家门店计划", "url": "https://example.com", "value_rating": "★★★"},
            {"title": "盒马鲜生推出新零售3.0战略", "url": "https://example.com", "value_rating": "★★★"},
        ],
        "p2_news": [
            {"title": "永辉超市完成供应链升级"},
            {"title": "7-11便利店进入新城市"},
        ],
        "dimensions": {"便利店": 10, "会员店": 8, "超市": 12}
    }
